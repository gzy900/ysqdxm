...
<!--              00:15:27-->
      ...
      <div v-if="params.type==='1'">
        ...
        <div class="info-subTitle mt8">
          <p>
            <span style="color: rgba(161, 160, 245, 1);">{{ dataInfo.monitorMin }}min</span>
...
<!--        </div>-->
      ...
      <pie :names="dataInfo.pieData.names" :nums="dataInfo.pieData.nums" :isSleep="params.type"></pie>

      <div id="heartbeatChart" style="height: 186px"></div>

      <div class="info-data-lattice mt12">
        <p>
          <span style="color: rgba(255, 101, 132, 1)">{{ dataInfo.info.totalHeartRate }}</span>
          <span>总心跳数</span>
        </p>
        <p>
          <span style="color: rgba(65, 105, 220, 1)">{{ dataInfo.info.avgHeartRate }}</span>
          <span>平均心率</span>
        </p>
        <p>
          <span style="color: rgba(20, 166, 147, 1)">{{ dataInfo.info.minHeartRate }}</span>
          <span>最小心率</span>
        </p>
        <p>
          <span style="color: rgba(229, 52, 73, 1)">{{ dataInfo.info.maxHeartRate }}</span>
          <span>最大心率</span>
        </p>
      </div>
      ...
      <div class="info-section mt8" style="position: relative">
        <span style="width: 33.3%;background: #4ED4AF;"></span>
        <span style="width: 33.4%;background: #FFB49C;"></span>
        <span style="width: 33.3%;background: #FF7C91;"></span>
      ...
      <p class="info-explain-label mt8">
        <span>
          <svg-icon icon-class="icon-kuai" color="#4ED4AF"></svg-icon>压力低
        </span>
        <span>
          <svg-icon icon-class="icon-kuai" color="#FFB49C"></svg-icon>压力中
        </span>
        <span>
          <svg-icon icon-class="icon-kuai" color="#FF7C91"></svg-icon>压力高
        </span>
        <span>
      ...
      <div class="info-data-list">
        ...
        <p>
          ...
          <span>{{ dataInfo.info.sdnnidx }}ms</span>
        </p>
        <p>
          <span>
            <svg-icon icon-class="icon-point" color="rgba(20, 166, 147, 1)"/>
          ...
          <span>{{ dataInfo.info.rmssd }}ms</span>
        </p>
        <p>
          <span>
            <svg-icon icon-class="icon-point" color="rgba(20, 166, 147, 1)"/>
        ...
        <p>
          ...
          <span>{{ dataInfo.info.triangleIndex }}ms</span>
        </p>
      </div>
      ...
      <template v-if="params.type!=='2'||params.simple!=='1'">
        ...
        <div class="info-subTitle mt8">
          <p>
                <span class="circular-progress">
                  ...
                  <span
                      :style="{background: 'conic-gradient(rgba(244, 196, 74, 1), rgba(244, 196, 74, 1) '+(dataInfo.xgzb*360)+'deg, transparent '+(dataInfo.xgzb*360)+'deg, transparent)'}"></span>
                </span>
            <span>异常占比</span>
          </p>
          <p>
        ...
        <xgChart v-if="dataInfo.xgShow" class="mt3" :chartData="dataInfo.xgData" :id="'xgChart'" :isSwiper="true"
        ...
        <div class="info-subTitle mt8">
          ...
          <p>
            <span style="color: rgba(65, 105, 220, 1);">{{ (dataInfo.ngNum / 100).toFixed(2) }}</span>
            <span>概率</span>
          </p>
          <p>
        ...
        <xgChart v-if="dataInfo.ngShow" class="mt3" :chartData="dataInfo.ngData" :id="'ngChart'" :isSwiper="true"
                 :isSleep="params.type"></xgChart>
