...
function getRegisterPaths(registerInfos) {
    ...
    var registerInfos = [
  {
    ...
    "buildin": "register_9bb32ec6.json",
    "idePack": "register_43600e4c.json"
  },
  {
    "platform": [
      "etc1"
  ...
  },
  {
    ...
    "buildin": "register_9bb32ec6.json",
    "idePack": "register_ee98da61.json"
  },
  {
    "platform": [
      "pvr"
    ...
    "buildin": "register_9bb32ec6.json",
    "idePack": "register_1f2a6485.json"
  },
  {
    "platform": [
      "astc"
    ...
    "buildin": "register_9bb32ec6.json",
    "idePack": "register_2f4644e4.json"
  },
  {
    "platform": [
      "s3tc"
    ...
    "buildin": "register_9bb32ec6.json",
    "idePack": "register_d0ab7309.json"
  }
]
    ...
    engine.loader.load("resource/loading.scene", { useFrameSystem: false }).promise.then(function (scene) {
