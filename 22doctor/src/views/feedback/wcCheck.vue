      ...
      <el-row :getter="20">
        ...
        <el-col :span="8">
          ...
          <div style="text-align: left;margin-left: 120px">
            ...
            <!--              提交-->
            <!--            </el-button>-->
            <el-button type="success" size="small" @click="handleCheck({row:{id:fromData.id}},2)">通过</el-button>
            <el-button type="danger" size="small" @click="handleCheck({row:{id:fromData.id}},3)">打回</el-button>
...
export default {
  ...
  created() {
    ...
    this.listQuery.checkId = this.userInfo.doctorId
