...
<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="反馈状态" width="100">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="锁定医生" width="110">
        <template slot-scope="scope">
...
import { getList, getDanDaoById, getAdminList, getLockInfo, unLock } from '@/api/arrhythmia'
...
import heartChart from '@/components/heart-chart/ischemia-charts'
import arrhythmiaHistory from './charts/ischemia-history'
