...
<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="剩余时间" width="100">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="测量时间" width="160">
        <template slot-scope="scope">
      ...
      <el-row :getter="20">
        <el-col :span="16">
          ...
          <el-tabs v-if="dialogVisible" type="border-card" @tab-click="resizeChart">
            <el-tab-pane label="当前数据" :lazy="true">
              ...
              <!--              <cardiac-load-chart ref="cardiac-load-chart" v-if="dialogVisible"  width="100%" height="340px" :row="row" :isImport="fromData.isImport" @appendImg="appendImg"/>-->
            </el-tab-pane>
            <el-tab-pane label="历史数据" :lazy="true">
              <!--              <cardiac-load-history ref="cardiac-load-history" v-if="dialogVisible" width="100%" height="340px" :row="row" @appendImg="appendImg" />-->
        ...
        <el-col :span="8">
          ...
          <div class="el-tag-div">
            <tag v-if="dialogVisible" :type="2" :is-import="fromData.isImport" @appendTag="appendTag"/>
          </div>
...
import cardiacLoadChart from './charts/cardiac-load-chart'
import cardiacLoadHistory from './charts/cardiac-load-history'
...
export default {
  ...
  components: { arrhythmiaHistory, heartChart, Pagination, Tag },
  data() {
    return {
  ...
  computed: {
    ...
    subTitle() {
      let subTitle = 'SDN：' + this.row.heart_change + '; ' + 'PSI：' + this.row.PSI + '; ' + 'HR：' + this.row.heart_rate_avg + '; '
