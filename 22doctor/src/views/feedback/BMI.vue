...
<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="BMI" width="120">
        <template slot-scope="scope">
          {{ scope.row.BMI }}
        </template>
      </el-table-column>
    ...
    <el-dialog :visible.sync="dialogVisible" :title="'反馈'" :fullscreen="true" @close="closeDialog">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-card>
            <LineMarker v-if="dialogVisible" height="260px" width="100%" :uuid="fromData.patientId" :row="row" @appendImg="appendImg" />
          </el-card>
        </el-col>
        <el-col :span="12">
          ...
          <div class="el-tag-div">
            <tag :type="3" @appendTag="appendTag" />
          </div>
...
export default {
  ...
  methods: {
    ...
    handleEdit(scope) {
      ...
      this.fromData.privateId = scope.row.id
