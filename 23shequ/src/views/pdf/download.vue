<template>
  <div v-loading.fullscreen.lock="fullscreenLoading" class="main-article" element-loading-text="正在导出PDF。。。">
...
export default {
  ...
  mounted() {
    this.fetchData(JSON.parse(localStorage.getItem('PDF_info')))
  },
  methods: {
    fetchData(data) {
      const { title } = data
