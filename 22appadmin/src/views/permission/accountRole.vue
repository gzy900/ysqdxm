...
info:账户管理
author:wanq
time:2020-05-08 13:17:50
-->
<template>
  <div class="app-container">
    <el-row>
      <el-col :span="6">
        <el-button type="primary" @click="handleAddRole">新建账户</el-button>
      </el-col>
      <el-col :span="18">
    ...
    <el-table :data="rolesList" style="width: 100%;margin-top:30px;" border>
      <el-table-column align="center" label="账户ID" width="220">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="账户名称" width="220">
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="220">
        <template slot-scope="scope">
          ...
          <el-button type="warning" size="small" @click="handleDelete(scope)">停用</el-button>
        </template>
      </el-table-column>
    </el-table>
