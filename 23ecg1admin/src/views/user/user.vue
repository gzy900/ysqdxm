<template>
  <div>
    ...
    <!--                &lt;!&ndash;                <el-button type="info" class="pan-btn ash-btn"><i class="el-icon-refresh-right"/> 还原</el-button>&ndash;&gt;-->
    <!--              </p>-->
    <!--            </div>-->
    <!--          </el-col>-->
    <!--        </el-row>-->
    ...
    <el-card style="margin-top: 20px" class="page-content" :class="userDataView||'dark'">
    ...
    <el-dialog
      :title="userInfoDialogType==='add'?'新增用户':'用户详情'"
    ...
    >
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="用户姓名">
          <el-col :span="8">
            <el-input v-model="form.uploadUserName"></el-input>
          </el-col>
        </el-form-item>
...
import { getList, addData, upData } from '@/api/ECG1/user'
